...
function Copy-Object {
    ...
    {
        $serialised = [System.Management.Automation.PSSerializer]::Serialize($Original)
        $DeepClone.Value = [System.Management.Automation.PSSerializer]::Deserialize($serialised)
    }
}
