...
Eirctl has the ability to create a dependency graph for each of the pipelines that have been configured.
...
[source,bash]
----
eirctl graph build | dot -Tpng -o build_pipeline.png
----