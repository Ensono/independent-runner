...
- Not only can tasks be defined, but pipelines as well. This means that the different stages can be defined within the configuration can called as required by the operator (be it human or a CI/CD agent)
